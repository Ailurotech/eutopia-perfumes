    ...
    <div className='bg-[#F5E1C9] w-screen md:h-[80vh] flex items-center'>
      <Splide hasTrack={ false } options={options} className="">
        ...
        <div className="splide__arrows !text-white !fill-white">
          <button className="splide__arrow splide__arrow--prev md:ml-36 text-1xl md:text-5xl !left-16 md:!left-0"><Icon name='arrow'  style={{ fill: 'white' }}/></button>
          <button className="splide__arrow splide__arrow--next md:mr-36 text-1xl md:text-5xl !right-16 md:!right-0"><Icon name='arrow' style={{ fill: 'white' }}/></button>
        </div>
      </Splide>
    </div>
  );

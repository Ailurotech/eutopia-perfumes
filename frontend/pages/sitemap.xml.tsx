...
export const getServerSideProps: GetServerSideProps = async ({ res }) => {
  ...
  const staticRoutes: SitemapEntry[] = [
    {
      loc: `${baseUrl}`,
      description: 'Revolutionising the Essence of Luxury with Affordable, Locally Crafted Fragrances for Everyone. Born from a Vision of Inclusivity and Sustainability in Brisbane.'
    },
    {
      loc: `${baseUrl}/all`,
    ...
    {
      loc: `${baseUrl}/for-her`,
      description: 'Elegant Aromas: Shop Online to Discover Your Signature Scent.'
    },
    {
      loc: `${baseUrl}/for-him`,
    ...
    {
      loc: `${baseUrl}/story`,
      description: 'The Vision Behind Eutopia Perfumes: Crafting Affordable Luxury.'
    },
